        ...
        weixin_login_btn.addTouchEventListener(function (sender, eventType) {
            if (eventType === ccui.Widget.TOUCH_ENDED) {
                ...
                if (info_json) {
                    ...
                    if ((cc.sys.os == cc.sys.OS_ANDROID && cc.sys.isNative) || ((cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative) && cc.sys.isNative)) {
                    ...
                    } else if (((cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative) && cc.sys.isNative)) {
